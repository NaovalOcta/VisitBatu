...
@section('admin_content')
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
            <h2 class="font-serif text-2xl font-bold text-gray-800">Kategori Wisata</h2>
            <p class="text-gray-500 text-sm">Kelola kategori untuk mengelompokkan paket wisata.</p>
        </div>
    ...
    {{-- Table Container --}}
    <div class="bg-white border border-gray-100 rounded-3xl shadow-sm overflow-hidden max-w-4xl">
                ...
                <tbody class="divide-y divide-gray-50">
                    @forelse($categories as $index => $category)
                        <tr class="hover:bg-gray-50/60 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                <span class="inline-block px-2 py-1 bg-gray-100 rounded text-xs text-gray-500 font-mono">
                                    {{ $category->slug }}
                                </span>
                            </td>
                            ...
                            <td colspan="4" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center text-gray-400">
                                    <div class="h-16 w-16 bg-gray-50 rounded-full flex items-center justify-center mb-3">
                                        <i class="icon-folder-open text-2xl text-gray-300"></i>
                                    </div>
                                    <p class="font-medium text-gray-500">Belum ada kategori.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
