...
@section('admin_content')
    <div class="max-w-auto px-4 sm:px-6 lg:px-8 py-8">
        {{-- Header Section --}}
        <div class="mb-8">
        ...
        @if (session('success'))
            <div class="mb-6 p-4 rounded-2xl bg-green-50 dark:bg-green-950/20 border border-green-100 dark:border-green-900/40 text-green-800 dark:text-white/80 flex items-center gap-3">
                        ...
                        <div class="flex-1 w-full space-y-6">
                            <div>
                                ...
                                <input type="text" name="name" value="{{ old('name', $user->name) }}"
                                    class="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-night-900 border-transparent focus:bg-white dark:focus:bg-night-800 focus:border-teal-500 focus:ring-2 focus:ring-teal-200 outline-none transition-all font-medium text-gray-800 dark:text-white/80"
                                    required>
                            </div>
                        ...
                        @if ($user->password)
                            <div class="md:col-span-2">
                                ...
                                <input type="password" name="current_password"
                                    class="w-full px-4 py-3 rounded-xl bg-gray-50 dark:bg-night-900 border-transparent focus:bg-white dark:focus:bg-night-800 focus:border-teal-500 focus:ring-2 focus:ring-teal-200 outline-none transition-all text-gray-800 dark:text-white/80"
                                    required>
                            </div>
                        @else
                            <div
                                class="md:col-span-2 p-4 rounded-2xl bg-teal-50 dark:bg-teal-950/20 border border-teal-100 dark:border-teal-900/40 text-teal-800 dark:text-white/80 text-sm">
