...
@section('content')
    <div x-data="{ isLoading: false }" class="w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden p-8 md:p-12 m-4">
        <div class="text-center">
            ...
            <h1 class="font-serif text-2xl md:text-3xl font-bold text-gray-900 mb-4">Lupa Password?</h1>
            ...
            <div class="mt-8 pt-6 border-t border-gray-100">
                <a href="{{ route('login') }}"
                    class="text-primary-700 font-bold hover:text-primary-900 text-sm transition transition">
