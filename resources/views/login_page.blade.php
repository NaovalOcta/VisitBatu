...
<html lang="en">
  <head>
    <title>Login &mdash; Trips Travel</title>
    <meta charset="utf-8">
            ...
            <div class="col-md-5" data-aos="fade-up">
              ...
              <div class="text-center mb-4">
                <a href="{{ route('welcome_page') }}">
                  <img src="images/logo.png" alt="Image" class="img-fluid" style="max-width: 150px;">
                </a>
              </div>
              ...
              <div class="login-card">
                ...
                <form action="#" method="POST">
                  ...
                  <div class="text-center mt-4">
                    <p class="small text-muted">Don't have an account? <a href="{{ route('register_page') }}" class="text-primary">Register here</a></p>
                  </div>
                </form>
              </div>
