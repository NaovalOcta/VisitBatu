<footer class="bg-gray-900 text-white pt-20 pb-10 border-t border-gray-800 relative overflow-hidden font-sans">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-12 mb-16 border-b border-gray-800 pb-12">
            ...
            <div class="lg:col-span-3 bg-gray-800/50 rounded-2xl p-8 border border-gray-700/50">
                <h3 class="text-xl font-bold font-serif mb-2">Bergabung dengan Newsletter Kami</h3>
                <p class="text-gray-400 text-sm mb-6">Dapatkan info promo tiket dan rekomendasi wisata tersembunyi
                    setiap minggunya.</p>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12 mb-16">
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    <li><a href="{{ url('/') }}"
                            class="hover:text-accent-400 transition flex items-center gap-2">Beranda</a></li>
                    <li><a href="{{ url('/trips') }}"
                            class="hover:text-accent-400 transition flex items-center gap-2">Destinasi Wisata</a></li>
                    <li><a href="{{ url('/blog') }}"
                            class="hover:text-accent-400 transition flex items-center gap-2">Cerita Perjalanan</a></li>
                    <li><a href="#" class="hover:text-accent-400 transition flex items-center gap-2">Peta
                            Wisata</a></li>
                </ul>
            </div>
