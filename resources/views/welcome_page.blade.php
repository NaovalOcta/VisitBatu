        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="col-9  text-right">
              <span class="d-inline-block d-lg-none"><a href="#" class="site-menu-toggle js-menu-toggle py-5 text-white"><span class="icon-menu h3 text-white"></span></a></span>
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  <li class="active"><a href="{{ route('welcome_page') }}" class="nav-link">Home</a></li>
                  <li><a href="{{ route('about_page') }}" class="nav-link">About</a></li>
                  <li><a href="{{ route('trips_page') }}" class="nav-link">Trips</a></li>
                  <li><a href="{{ route('blog_page') }}" class="nav-link">Blog</a></li>
                  <li><a href="{{ route('contact_page') }}" class="nav-link">Contact</a></li>
                </ul>
              </nav>
            </div>
          </div>
